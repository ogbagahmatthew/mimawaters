...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="blue">Tip 1: You can change the color of the sidebar using: data-color="blue | green | orange | red | yellow"
      ...
      <div class="logo">
        <a href="mimawaters.herokuapp.com" class="simple-text logo-mini">
        <img src="images/mima logo.png">
        </a>
        <a href="mimawaters.herokuapp.com" class="simple-text logo-normal">
          Mima Waters
        </a>
      </div>
