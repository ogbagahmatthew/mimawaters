...
<head>
    <title>MIMA WATERS | contact ::</title>
...
<body>
    ...
    <div class="inner-banner">
        ...
        <header>
            <nav class="navbar navbar-expand-lg navbar-light bg-gradient-secondary pt-3">
                <h1>
                    <a class="navbar-brand text-white" href="{{url('contact')}}">
                    </a> 
                </h1>
    ...
    <div class="agileits-services py-md-5 py-4">
        ...
        <div class="col-lg-7 col-md-7 col-sm-7 ____mobiup">
            ...
            <p class="__abomi1 ">
                    Mima Shittu Wagner Nigeria Limited 
1,Agboola Aina Street, Off Amore Street,
     by St. Leo Catholic Church, Toyin Street, Ikeja, Lagos
Tel: 08132194748, 080555524300
www.mimawaters.com
sales@mimawaters.com
                </p>
                </div>
                <!-- <div class="col-lg-5 col-md-5 col-sm-5 __mobildown">
                <img src="images/mima pack.jpg" alt="" class="" style="width:100%">
